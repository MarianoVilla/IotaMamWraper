...
namespace IOTAAPI.Lib
{
    ...
    public class IotaMamConnection
    {
        ...
        public int Timeout { get; private set; } = 50000;
        ...
        public IotaMamConnection(string Seed, params string[] Nodes)
        {
            if (InvalidNodes(Nodes))
                throw new ArgumentException("No nodes received!");
            this.ConnectionSeed = new Seed(Seed);
            SetUp(Nodes);
        }
        public IotaMamConnection(string Seed, IEnumerable<string> Nodes) : this(Seed, Nodes.ToArray()) { }
        #endregion
        ...
        private void CreateSubscription(MaskedAuthenticatedMessage message)
        {
            ...
            this.Root = FirstMessage.Root.Value;
